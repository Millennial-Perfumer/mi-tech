.PHONY: install install-frontend install-frontend-v2 install-frontend-feedback install-backend run frontend fe-v2 frontend-feedback backend build build-frontend build-frontend-v2 build-frontend-feedback build-backend clean db-up db-down
...
install: install-frontend install-frontend-v2 install-frontend-feedback install-backend
...
build: build-frontend build-frontend-v2 build-frontend-feedback build-backend
