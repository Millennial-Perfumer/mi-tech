...
func NewSyncService(shopifyClient *shopify.Client, orderRepo orderRepoPkg.OrderRepository, customerService *orderServicePkg.CustomerService, orchestrator *SyncOrchestrator) *SyncService {
	return &SyncService{
...
func (s *SyncService) Sync(startTime *time.Time, endTime *time.Time) (int, error) {
	...
	var orderEntities []orderEntity.Order
