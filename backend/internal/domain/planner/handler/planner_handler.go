...
import (
	...
	"mi-tech/internal/domain/planner/dto"
	"mi-tech/internal/domain/planner/repository"
	"mi-tech/internal/domain/planner/service"
)

type PlannerHandler struct {
	service      *service.PlannerService
	agentService *communicationServicePkg.AgentService
}

func NewPlannerHandler(service *service.PlannerService, agentService *communicationServicePkg.AgentService) *PlannerHandler {
