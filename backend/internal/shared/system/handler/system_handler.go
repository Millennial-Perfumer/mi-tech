...
type SystemHandler struct {
	systemService *systemServicePkg.SystemService
}

// NewSystemHandler creates a new SystemHandler.
func NewSystemHandler(systemService *systemServicePkg.SystemService) *SystemHandler {
...
// @Security Bearer
// @Produce json
// @Success 200 {array} systemServicePkg.Document
