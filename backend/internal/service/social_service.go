...
type SocialService interface {
	...
	GetPostInsights(postID string, mediaType string) (*marketing.DetailedInsights, error)
	CheckAssetHealth() (*marketing.AssetHealth, error)
}
...
func NewSocialService(repo repository.SocialRepository, metaClient *marketing.MetaMarketingClient) SocialService {
...
func (s *socialService) GetOverview(platform string, startDate, endDate string) (map[string]interface{}, error) {
	...
	case "instagram":
		...
		if err != nil {
			...
			accountStats = &marketing.AccountInsights{} // Default empty to avoid panic
		}
...
func (s *socialService) GetPostInsights(postID string, mediaType string) (*marketing.DetailedInsights, error) {
...
func (s *socialService) CheckAssetHealth() (*marketing.AssetHealth, error) {
