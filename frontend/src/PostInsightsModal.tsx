              ...
              {hasReachData ? (
                <>
                  <div style={{ marginBottom: '1rem' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.85rem', marginBottom: '0.4rem', opacity: 0.8 }}>
                      <span>Followers</span>
                      <span>{reachFollower.toLocaleString()} ({reachFollowerPct}%)</span>
                    </div>
                    <div style={{ height: '6px', background: 'rgba(255,255,255,0.1)', borderRadius: '3px', overflow: 'hidden' }}>
                      <div style={{ height: '100%', width: `${reachFollowerPct}%`, background: '#E1306C', borderRadius: '3px', transition: 'width 0.6s ease' }} />
                    </div>
                  </div>
                ...
                <div style={{
                  padding: '1.25rem',
                  background: isCarousel ? 'rgba(255, 255, 255, 0.04)' : isRecent ? 'rgba(245, 158, 11, 0.05)' : 'rgba(255, 255, 255, 0.04)',
                  border: isCarousel ? '1px solid rgba(255, 255, 255, 0.08)' : isRecent ? '1px solid rgba(245, 158, 11, 0.15)' : '1px solid rgba(255, 255, 255, 0.08)',
                  borderRadius: '16px',
                  marginBottom: '2rem',
                  fontSize: '0.85rem'
                }}>
                  <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start' }}>
                    ...
                    <div>
                      <div style={{ fontWeight: 700, color: isRecent && !isCarousel ? '#f59e0b' : 'rgba(255,255,255,0.9)', marginBottom: '0.25rem' }}>
            ...
            <section style={{ borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '2.5rem' }}>
              ...
              <div style={{ marginBottom: '2rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <span style={{ opacity: 0.7 }}>Post interactions</span>
                ...
                {[
                  ...
                  <div key={i.label} style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.95rem' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.7rem' }}>
                      ...
                      <span style={{ opacity: 0.8 }}>{i.label}</span>
                    </div>
