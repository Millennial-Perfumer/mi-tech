              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead style={{ position: 'sticky', top: 0, background: 'var(--surface-color)', zIndex: 1, borderBottom: '1px solid var(--border-color)' }}>
                  <tr style={{ textAlign: 'left' }}>
                    ...
                    <th style={{ padding: '1rem 2rem', fontSize: '0.75rem', fontWeight: 700, color: 'var(--text-tertiary)', textTransform: 'uppercase' }} aria-sort={sortConfig?.key === 'customer_name' ? (sortConfig.direction === 'asc' ? 'ascending' : 'descending') : undefined}>
                    ...
                    <th style={{ padding: '1rem 2rem', fontSize: '0.75rem', fontWeight: 700, color: 'var(--text-tertiary)', textTransform: 'uppercase' }} aria-sort={sortConfig?.key === 'order_number' ? (sortConfig.direction === 'asc' ? 'ascending' : 'descending') : undefined}>
                    ...
                    <th style={{ padding: '1rem 2rem', fontSize: '0.75rem', fontWeight: 700, color: 'var(--text-tertiary)', textTransform: 'uppercase' }} aria-sort={sortConfig?.key === 'delivered_at' ? (sortConfig.direction === 'asc' ? 'ascending' : 'descending') : undefined}>
