        ...
        >
          ...
          >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
              ...
              {/* Performance Section */}
              <div className="modal-section" style={{ background: 'rgba(255,255,255,0.02)', padding: '1.5rem', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.05)' }}>
                <h3 style={{ fontSize: '0.7rem', color: '#6B7280', textTransform: 'uppercase', marginBottom: '1.5rem', letterSpacing: '1px' }}>Core Financials</h3>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                  <div>
                    <div style={{ fontSize: '0.6rem', color: '#9CA3AF', marginBottom: '4px' }}>SPEND</div>
                    <div style={{ fontSize: '1.1rem', fontWeight: 800, color: '#F9FAFB' }}>{formatCurrency(getInsightForId(selectedAd.id)?.spend || 0)}</div>
                  </div>
                  <div>
                    <div style={{ fontSize: '0.6rem', color: '#9CA3AF', marginBottom: '4px' }}>ROAS</div>
                    <div style={{ fontSize: '1.1rem', fontWeight: 800, color: '#10B981' }}>{parseFloat(getInsightForId(selectedAd.id)?.purchase_roas_val || '0').toFixed(2)}x</div>
                  </div>
                  <div>
                    <div style={{ fontSize: '0.6rem', color: '#9CA3AF', marginBottom: '4px' }}>CPC</div>
                    <div style={{ fontSize: '1.1rem', fontWeight: 800, color: '#F9FAFB' }}>{formatCurrency(getInsightForId(selectedAd.id)?.cpc || 0)}</div>
                  </div>
                  <div>
                    <div style={{ fontSize: '0.6rem', color: '#9CA3AF', marginBottom: '4px' }}>CPM</div>
                    <div style={{ fontSize: '1.1rem', fontWeight: 800, color: '#F9FAFB' }}>{formatCurrency(getInsightForId(selectedAd.id)?.cpm || 0)}</div>
                  </div>
                </div>
              </div>
              ...
              {/* Quality & Visibility */}
              <div className="modal-section" style={{ background: 'rgba(255,255,255,0.02)', padding: '1.5rem', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.05)' }}>
                <h3 style={{ fontSize: '0.7rem', color: '#6B7280', textTransform: 'uppercase', marginBottom: '1.5rem', letterSpacing: '1px' }}>Quality & Delivery</h3>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                  <div>
                    <div style={{ fontSize: '0.6rem', color: '#9CA3AF', marginBottom: '4px' }}>FREQUENCY</div>
                    <div style={{ fontSize: '1.1rem', fontWeight: 800, color: '#F9FAFB' }}>{parseFloat(getInsightForId(selectedAd.id)?.frequency || '0').toFixed(2)}</div>
                  </div>
                  <div>
                    <div style={{ fontSize: '0.6rem', color: '#9CA3AF', marginBottom: '4px' }}>REACH</div>
                    <div style={{ fontSize: '1.1rem', fontWeight: 800, color: '#F9FAFB' }}>{formatNumber(getInsightForId(selectedAd.id)?.reach || 0)}</div>
                  </div>
                  <div>
                    <div style={{ fontSize: '0.6rem', color: '#9CA3AF', marginBottom: '4px' }}>QUAL. RANK</div>
                    <div style={{ fontSize: '0.8rem', fontWeight: 800, color: '#60A5FA' }}>{getInsightForId(selectedAd.id)?.quality_ranking?.replace(/_/g, ' ') || 'AVERAGE'}</div>
                  </div>
                  <div>
                    <div style={{ fontSize: '0.6rem', color: '#9CA3AF', marginBottom: '4px' }}>CONV. RANK</div>
                    <div style={{ fontSize: '0.8rem', fontWeight: 800, color: '#60A5FA' }}>{getInsightForId(selectedAd.id)?.conversion_rate_ranking?.replace(/_/g, ' ') || 'AVERAGE'}</div>
                  </div>
                </div>
              </div>
              ...
              {/* Social Engagement */}
              <div className="modal-section" style={{ background: 'rgba(255,255,255,0.02)', padding: '1.5rem', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.05)' }}>
                <h3 style={{ fontSize: '0.7rem', color: '#6B7280', textTransform: 'uppercase', marginBottom: '1.5rem', letterSpacing: '1px' }}>Social Engagement</h3>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                  <div>
                    <div style={{ fontSize: '0.6rem', color: '#9CA3AF', marginBottom: '4px' }}>CLICKS</div>
                    <div style={{ fontSize: '1.1rem', fontWeight: 800, color: '#F9FAFB' }}>{formatNumber(getInsightForId(selectedAd.id)?.inline_link_clicks || 0)}</div>
                  </div>
                  <div>
                    <div style={{ fontSize: '0.6rem', color: '#9CA3AF', marginBottom: '4px' }}>CTR</div>
                    <div style={{ fontSize: '1.1rem', fontWeight: 800, color: '#F9FAFB' }}>{parseFloat(getInsightForId(selectedAd.id)?.ctr || '0').toFixed(2)}%</div>
                  </div>
                  <div>
                    <div style={{ fontSize: '0.6rem', color: '#9CA3AF', marginBottom: '4px' }}>REACTIONS</div>
                    <div style={{ fontSize: '1.1rem', fontWeight: 800, color: '#F9FAFB' }}>{formatNumber(getInsightForId(selectedAd.id)?.post_reaction || 0)}</div>
                  </div>
                  <div>
                    <div style={{ fontSize: '0.6rem', color: '#9CA3AF', marginBottom: '4px' }}>COMMENTS</div>
                    <div style={{ fontSize: '1.1rem', fontWeight: 800, color: '#F9FAFB' }}>{formatNumber(getInsightForId(selectedAd.id)?.post_comment || 0)}</div>
                  </div>
                </div>
              </div>
              ...
              {/* Video Funnel */}
              <div className="modal-section" style={{ background: 'rgba(255,255,255,0.02)', padding: '1.5rem', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.05)' }}>
                <h3 style={{ fontSize: '0.7rem', color: '#6B7280', textTransform: 'uppercase', marginBottom: '1.5rem', letterSpacing: '1px' }}>Video Funnel</h3>
                <div style={{ borderLeft: '2px solid rgba(255,255,255,0.05)', paddingLeft: '1.5rem' }}>
                  <div style={{ marginBottom: '1rem' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.7rem', color: '#9CA3AF', marginBottom: '5px' }}>
                      <span>25% Watched</span>
                      <span style={{ fontWeight: 800, color: '#F9FAFB' }}>{formatNumber(getInsightForId(selectedAd.id)?.video_p25_watched_actions || 0)}</span>
                    </div>
                    <div style={{ height: '4px', background: '#374151', borderRadius: '2px' }}>
                      <div style={{ height: '100%', width: '100%', background: '#60A5FA', borderRadius: '2px' }}></div>
                    </div>
                  ...
                  <div style={{ marginBottom: '1rem' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.7rem', color: '#9CA3AF', marginBottom: '5px' }}>
                      <span>50% Watched</span>
                      <span style={{ fontWeight: 800, color: '#F9FAFB' }}>{formatNumber(getInsightForId(selectedAd.id)?.video_p50_watched_actions || 0)}</span>
                    </div>
                    <div style={{ height: '4px', background: '#374151', borderRadius: '2px' }}>
                      <div style={{ height: '100%', width: '50%', background: '#60A5FA', borderRadius: '2px' }}></div>
                    </div>
                  ...
                  <div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.7rem', color: '#9CA3AF', marginBottom: '5px' }}>
                      <span>100% Watched</span>
                      <span style={{ fontWeight: 800, color: '#F9FAFB' }}>{formatNumber(getInsightForId(selectedAd.id)?.video_p100_watched_actions || 0)}</span>
                    </div>
                    <div style={{ height: '4px', background: '#374151', borderRadius: '2px' }}>
                      <div style={{ height: '100%', width: '20%', background: '#60A5FA', borderRadius: '2px' }}></div>
                    </div>
