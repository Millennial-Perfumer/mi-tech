    ...
    API: {
      ...
      streamResponse: async function (userMessage, conversationId, messagesContainer) {
        ...
        try {
          ...
          const appUrl = window.shopChatConfig?.appUrl || 'https://localhost:3458';
      ...
      fetchChatHistory: async function (conversationId, messagesContainer) {
        try {
          ...
          if (!data.messages || data.messages.length === 0) {
            const welcomeMessage = window.shopChatConfig?.welcomeMessage || "Welcome to Millennial Perfumer. ✨ I am your Mills Concierge. I am delighted to help you discover your signature scent 🧪, browse our fragrance notes 🌿, or look up your order status 📦. What can I help you discover today?";
